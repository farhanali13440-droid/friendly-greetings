...
function HomePage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white text-slate-900">
      ...
      <section id="doctor" className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28"><div className="grid gap-12 lg:grid-cols-[.75fr_1.25fr] lg:items-center"><div className="relative"><div className="aspect-[4/5] rounded-[34px] bg-gradient-to-br from-blue-100 via-slate-50 to-blue-50 p-6 shadow-inner"><div className="flex h-full items-end rounded-[27px] border border-white/80 bg-white/40 p-6"><div><div className="mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 text-white"><UserRound size={27}/></div><p className="text-sm font-bold uppercase tracking-[0.14em] text-blue-600">Consultant</p><p className="mt-1 text-2xl font-black">Dr. Ateeq Ur Rehman</p></div></div></div></div><div><Eyebrow>MEET YOUR CHILD SPECIALIST</Eyebrow><h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Dr. Ateeq Ur Rehman</h2><p className="mt-3 text-lg font-bold text-blue-600">MBBS, FCPS (Pediatrics) · Consultant Child Specialist & Neonatologist</p><p className="mt-6 leading-8 text-slate-600">Dr. Ateeq Ur Rehman has experience caring for newborns, infants, children and adolescents. He has worked as a Registrar at Mukhtar A Sheikh Hospital, Multan and Nishtar Hospital, Multan, gaining experience in tertiary pediatric and neonatal care.</p><p className="mt-4 leading-8 text-slate-600">His approach emphasizes accurate diagnosis, prevention, nutrition, growth and development, child-friendly care, parent counselling and avoiding unnecessary tests and medications while ensuring timely, guideline-based treatment.</p><div className="mt-8 grid gap-3 sm:grid-cols-2"><Credential title="MBBS" text="Bachelor of Medicine & Surgery"/><Credential title="FCPS Pediatrics" text="Fellow of CPSP"/><Credential title="Ex-Registrar" text="Mukhtar A Sheikh Hospital, Multan"/><Credential title="Ex-Registrar" text="Nishtar Hospital, Multan"/></div></div></div></section>
